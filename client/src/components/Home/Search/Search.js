...
const Search = ({setSearch, search}) => {
    ...
    return (
        <div className="mb-3.5 sm:flex justify-between items-center">
            <h1 className="sm:ml-5 sm:mb-0 text-3xl text-blue-900 mb-3">Books</h1>
            <div className="sm:flex items-center">
                <select onChange={renderCategoryChange} className="px-3 py-1.5 sm: w-full sm:w-1/2 sm:mr-3 mb-3 sm:mb-0 outline-none text-blue-900" name="category" id="category">
                ...
                <div className="relative flex justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 absolute top-1.5 left-4 text-blue-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
